...
| 에이전트 | 역할 | 필요 시점 |
|---------|------|----------|
| `tdd-agent` | TDD 사이클 강제 | 구현 전 테스트 작성 시 |
...
**개선 방안:**
- Phase 완료 시 코드 품질 검토 규칙화
- 보안 관련 파일 (security.py, auth.py) 수정 시 보안 검토 필요

**[ ] 선택사항:**
- [x] **A. 필요 시 활용** (권장 - 초기 단계)
- [ ] **B. 워크플로우 문서에 검증 시점 명시**
- [ ] **C. Phase별 품질 검증 규칙 정의**
